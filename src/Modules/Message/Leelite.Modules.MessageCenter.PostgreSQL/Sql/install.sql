...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210712044057_DbInitMessageCenter') THEN
...
BEGIN
    ...
    VALUES ('20210712044057_DbInitMessageCenter', '5.0.7');
    END IF;
END $$;
COMMIT;
