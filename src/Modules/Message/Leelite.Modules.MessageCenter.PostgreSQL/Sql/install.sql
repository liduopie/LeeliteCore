...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210710150738_DbInitMessageCenter') THEN
...
BEGIN
    ...
    VALUES ('20210710150738_DbInitMessageCenter', '5.0.7');
    END IF;
END $$;
COMMIT;
