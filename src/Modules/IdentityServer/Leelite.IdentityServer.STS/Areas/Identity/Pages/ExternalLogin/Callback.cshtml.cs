...
namespace Leelite.IdentityServer.STS.Areas.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, user.Id.ToString(), user.Account.UserName, true, context?.Client.ClientId));
